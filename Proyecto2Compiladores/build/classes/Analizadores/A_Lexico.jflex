...
<YYINITIAL> "^"         { System.out.println("Reconocio "+yytext()+" pote"); return new Symbol(Simbolos.parc, yycolumn, yyline, yytext()); }

//-------> Simbolos ER
<YYINITIAL> {numero}    { System.out.println("Reconocio "+yytext()+" num"); return new Symbol(Simbolos.num, yycolumn, yyline, yytext()); }
<YYINITIAL> {id}    { System.out.println("Reconocio "+yytext()+" id"); return new Symbol(Simbolos.num, yycolumn, yyline, yytext()); }
